            ...
            try:
                ...
                if self.mode == AiMode.Searching:
                    ...
                    if self.ArmState != ArmStates.top:
                        print('raising arms')
                        self.Interface(ControllCMDs.SetArmPos, [190,60], WaitForStatic=True)
                        cmdState = self.Interface(ControllCMDs.ArmMoveInCM, [-5,25], WaitForStatic=True)
